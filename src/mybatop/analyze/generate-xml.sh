...
process_xml_section "technical-specification" tech_spec.py "recent_usage.xml"
process_xml_section "average-capacity" dchar.py "recent_usage.xml"
process_xml_section "battery-capacity-history" batcaphis.py "batcaphis.xml"
process_xml_section "battery-health" battery_health.py "batcaphis.xml"
